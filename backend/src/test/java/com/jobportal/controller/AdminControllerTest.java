...
class AdminControllerTest {
    ...
    void setup() {
        ...
        adminController = new AdminController(userRepository, jobSeekerRepository, employerRepository, jobRepository, applicationRepository, jobService);
    }
    ...
    void dashboardShouldReturnCorrectCounts() {
        ...
        when(employerRepository.findByApprovalStatus(Employer.ApprovalStatus.PENDING)).thenReturn(Collections.emptyList());
        ...
        assertEquals(30L, dash.getApplicationsByStatus().get(JobApplication.ApplicationStatus.PENDING.name()).longValue());
