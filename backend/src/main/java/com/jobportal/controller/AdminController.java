...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse> getDashboard() {
        ...
        dashboard.setTotalJobSeekers(jobSeekerRepository.count());
        dashboard.setTotalEmployers(employerRepository.count());
        dashboard.setTotalJobs(jobRepository.count());
        dashboard.setTotalApplications(applicationRepository.count());
        dashboard.setPendingEmployerApprovals(
            (long) employerRepository.findByApprovalStatus(Employer.ApprovalStatus.PENDING).size()
        );
        dashboard.setActiveJobs(jobRepository.count() - jobRepository.count());
        dashboard.setInactiveJobs(0L);
